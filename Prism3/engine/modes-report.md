...
| disabled.surface | neutral.200 | — | — | · |
| disabled.on-disabled | neutral.550 | 3.04 | 3 | ✅ |
...
| disabled.surface | neutral.750 | — | — | · |
| disabled.on-disabled | neutral.450 | 3.08 | 3 | ✅ |
...
| disabled.surface | neutral.200 | — | — | · |
| disabled.on-disabled | neutral.650 | 4.51 | 4.5 | ✅ |
...
| disabled.surface | neutral.750 | — | — | · |
| disabled.on-disabled | neutral.300 | 4.92 | 4.5 | ✅ |
...
| disabled.surface | neutral.200 | — | — | · |
| disabled.on-disabled | neutral.550 | 3.08 | 3 | ✅ |
...
| interactive.destructive.overlay.selected | white-alpha.20 | 10.07 | 4.5 | ✅ |
| disabled.surface | neutral.750 | — | — | · |
| disabled.on-disabled | neutral.450 | 3.04 | 3 | ✅ |
...
| interactive.destructive.overlay.selected | black-alpha.20 | 13.08 | 7 | ✅ |
| disabled.surface | neutral.200 | — | — | · |
| disabled.on-disabled | neutral.650 | 4.53 | 4.5 | ✅ |
...
| interactive.destructive.overlay.selected | white-alpha.20 | 12.63 | 7 | ✅ |
| disabled.surface | neutral.750 | — | — | · |
| disabled.on-disabled | neutral.300 | 4.87 | 4.5 | ✅ |
...
| disabled.surface | neutral.750 | — | — | · |
| disabled.on-disabled | neutral.450 | 3.05 | 3 | ✅ |
| disabled.text | neutral.550 | 3.23 | 3 | ✅ |
| disabled.icon | neutral.550 | 3.23 | 3 | ✅ |
| disabled.border | neutral.750 | — | — | · |
| text.primary | neutral.025 | 18.11 | 7 | ✅ |
...
| interactive.destructive.overlay.selected | black-alpha.20 | 13.08 | 7 | ✅ |
| disabled.surface | neutral.200 | — | — | · |
| disabled.on-disabled | neutral.650 | 4.54 | 4.5 | ✅ |
...
| interactive.destructive.overlay.selected | white-alpha.20 | 12.63 | 7 | ✅ |
| disabled.surface | neutral.750 | — | — | · |
| disabled.on-disabled | neutral.300 | 4.89 | 4.5 | ✅ |
